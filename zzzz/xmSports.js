...
Surge
[Script]
小米运动111 = type=cron,cronexp="15 17 * * *",wake-system=1,timeout=3600,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/backUp/xmSports.js
...
let login_token = 'NQVBQFJyQktGHlp6QkpbRl5LRl5qek4uXAQEBAAAAAMrfRAyH3fyW2Dh6SJ-LGHGqB9HnUatDtEW7-R2Ec8FwngWJ8e7Gq4urIsrmxWF-TXEuLrz35mJxJfNq3sq0cW1sCROMIDKpcEmK9Zb9qd9ZWRRFwsIBvtBYM6I50tm5N95Yy3X_IWqa9sSeBPQTEI50gLJNPi0Vxxq4Sr_O_HCqVr5riuhfABZT1uxdC7Xizb-7paxP8kennABdryULiTw';
//需要修改的运动步数波动范围，脚本默认修改步数范围为1w9到2w5
const step = randomFriendPin($.getdata('xmMinStep')*1 || 15000, $.getdata('xmMaxStep')*1 || 22000);
//=====================自定义延迟（毫秒）半小时随机=================================
const randomTimeInMs = Math.random() * (1800000);
